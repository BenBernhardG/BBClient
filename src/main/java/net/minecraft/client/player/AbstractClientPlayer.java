...
public abstract class AbstractClientPlayer extends Player {
    ...
    public static void registerSkinTexture(ResourceLocation pTextureLocation, String pName) {
        ...
        if (abstracttexture == MissingTextureAtlasSprite.getTexture()) {
            AbstractTexture abstracttexture1 = new HttpTexture((File) null, String.format("http://skins.minecraft.net/MinecraftSkins/%s.png", StringUtil.stripColor(pName)), DefaultPlayerSkin.getDefaultSkin(createPlayerUUID(pName)), true, (Runnable) null);
    ...
    public float getFieldOfViewModifier() {
        ...
        return Reflector.ForgeHooksClient_getFieldOfView2.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFieldOfView2, this, f) : Mth.lerp(Minecraft.getInstance().options.fovEffectScale, 1.0F, f);
    }
