...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        for (int k = 0; k < this.menu.slots.size(); ++k) {
            ...
            if (this.isHovering(slot, (double) pMouseX, (double) pMouseY) && slot.isActive()) {
                ...
                int l = slot.x;
                int i1 = slot.y;
                renderSlotHighlight(pPoseStack, l, i1, this.getBlitOffset());
            }
        }
    ...
    public static void renderSlotHighlight(PoseStack pPoseStack, int pX, int pY, int pBlitOffset) {
        ...
        fillGradient(pPoseStack, pX, pY, pX + 16, pY + 16, -2130706433, -2130706433, pBlitOffset);
    ...
    public boolean mouseClicked(double pMouseX, double p_97749_, int pMouseY) {
        if (super.mouseClicked(pMouseX, p_97749_, pMouseY)) {
            ...
            boolean flag = this.minecraft.options.keyPickItem.matchesMouse(pMouseY) && this.minecraft.gameMode.hasInfiniteItems();
    ...
    private boolean isHovering(Slot pSlot, double pMouseX, double p_97777_) {
        return this.isHovering(pSlot.x, pSlot.y, 16, 16, pMouseX, p_97777_);
    }
