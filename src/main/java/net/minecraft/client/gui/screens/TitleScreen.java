...
public class TitleScreen extends Screen {
    ...
    private void createNormalMenuOptions(int pY, int pRowHeight) {
        ...
        (this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight, 200, 20, new TranslatableComponent("menu.multiplayer"), (p_169449_1_) ->
        {
    ...
    private void createDemoMenuOptions(int pY, int pRowHeight) {
        ...
        this.resetDemoButton = this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight, 200, 20, new TranslatableComponent("menu.resetdemo"), (p_169440_1_) ->
        {
            ...
            try {
                ...
                LOGGER.warn("Failed to access demo world", ioexception1);
            }
        }));
    ...
    private boolean checkDemoWorldPresence() {
        try {
            ...
            SystemToast.onWorldAccessFailure(this.minecraft, "Demo_World");
            LOGGER.warn("Failed to read demo world data", ioexception1);
            return false;
        }
    }
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if ((l & -67108864) != 0) {
            ...
            if (this.minceraftEasterEgg) {
                ...
                {
                    this.blit(pPoseStack, p_169445_2_, p_169445_3_, 0, 0, 99, 44);
                ...
                {
                    this.blit(pPoseStack, p_96766_2_, p_96766_3_, 0, 0, 155, 44);
    ...
    private void confirmDemo(boolean p_96778_) {
        if (p_96778_) {
            try {
                ...
                LOGGER.warn("Failed to delete demo world", ioexception1);
            }
        }
